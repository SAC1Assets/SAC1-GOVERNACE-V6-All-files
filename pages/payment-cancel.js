// pay.sableassent.com/payment-cancel
// PayPal redirects here if user cancels on PayPal's page
        ...
        <div style={{ width: '100%', maxWidth: 480, background: '#fff', borderRadius: 20, overflow: 'hidden', boxShadow: '0 32px 80px rgba(0,0,0,0.4)' }}>
          ...
          <div style={{ padding: 24, textAlign: 'center' }}>
            ...
            <a href={`https://${product.site}`}
              style={{ display: 'block', padding: '12px', borderRadius: 12, border: '1px solid #e2e8f0', color: '#64748b', fontWeight: 600, fontSize: 14 }}>
