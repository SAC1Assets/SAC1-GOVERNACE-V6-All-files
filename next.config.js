...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://app.base44.com https://api-m.paypal.com https://api.stripe.com https://rpc-mainnet.matic.network https://polygon-rpc.com https://auth.privy.io https://*.privy.io https://api.privy.io",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
